...
import { FileCheck, Filter, ArrowUpRight, Calendar } from 'lucide-react'
import EmptyState from '../../../components/ai-forum/common/EmptyState.jsx'

/**
 * 内容审核页 - Phase0 占位骨架
 * 为什么只做占位：AI 初审 + 人工审核队列联动功能属于 Phase4 职责，当前阶段仅需页面骨架
...
export default function ContentReviewPage() {
  return (
    <div className="space-y-5">
      ...
      {/* FilterBar 占位条（状态/风险等级/版块 select 占位） */}
      ...
      <div className="bg-card border border-border rounded-af-lg overflow-hidden">
        <EmptyState
          icon={FileCheck}
          title="Phase4 上线"
          description="AI 初审 + 人工审核队列联动功能 Phase4 交付，敬请期待"
          action={
            <Link
              to="/forum/admin"
